	...
	*{
    ...
    <body>
		...
		<div class="topnav">
			...
			<a   style="background:#2196F3;"  href="adminaddupdates.jsp">AddUpdates</a>
			<a href="admineditupdates.jsp">EditUpdates</a>
			<a href="adminviewproblems.jsp">ViewProblemsList</a>

		</div>
		</div>
		<h1 class="sub_head">Add New Updates For Technicians</h1>
		<%
		...
		<div class="body_space">
			<form method="post" action="adminaddupdate">
				
				<label for="user" style="margin-top:100px;" class="label">UPDATE HEADING</label>
				<div class="textarea_class">
					<textarea maxlength="200" class="textarea" name="uabout" cols="39" rows="2" placeholder="Enter the update heading" required pattern=".{255}"></textarea>
				</div>
				<label for="user" style="margin-top:100px;" class="label">UPDATE Description</label>
				<div class="textarea_class">
