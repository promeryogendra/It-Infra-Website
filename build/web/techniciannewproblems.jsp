...
#cancel:hover{
    ...
    <body>
		...
		<div class="topnav">
			...
			<a class="active" href="techniciannewproblems.jsp">NewProblems</a>	
		...
		<h1 class="sub_head">New Problems</h1>
					...
					%>
						<tr style="width:100%;height: 10px;">
							...
							<TD id="cancel" class="text-left4">
								<form action="technicianviewnewproblem.jsp" method="post">
