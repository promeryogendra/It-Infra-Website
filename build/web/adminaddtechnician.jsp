	...
	*{
    ...
    <body>
		...
		<div class="topnav">
			...
			<a class="active" href="adminaddtechnician.jsp">AddTechnician</a>
		...
		<h1 class="sub_head">ADD NEW TECHNICIAN</h1>
		<div>
			<div class="body_space">
				
			 <form action="adminaddtechnician" method="post" style="padding-left:10px;">
				...
				<strong style="font-size: 23px;">FULLNAME&nbsp;</strong><input  class="username" type="text" name="name" required placeholder="fullname"><br>
				...
				<strong style="font-size: 23px;">PHONE NO&nbsp;&nbsp;</strong><input  class="username" type="text" name="phone" pattern="[7-9]{1}[0-9]{9}" placeholder="phone" onkeypress="return AllowNumbersOnly(event)" required><br>
				<input class="subm" type="submit" value="SIGN UP">
				<%
					String signuperror="",color="red";
					session=request.getSession(false);
					signuperror=(String)session.getAttribute("techerror");
					if(signuperror==null || signuperror.isEmpty())
					{
						signuperror="Please Enter all fields.....";
						color="green";
					}
					else if(signuperror.equals("Technician successfully added....."))
					{
						color="green";
					}
					session.setAttribute("techerror",null);
					%>
