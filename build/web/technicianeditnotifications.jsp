<%@page import="itinfra.notification"%>
...
#cancel:hover{
    ...
    <body>
		...
		<div class="topnav">
			...
			<a  class="active"  href="technicianeditnotifications.jsp">Editnotifications</a>
			<a href="technicianaddupdates.jsp">AddUpdates</a>
			<a href="technicianeditupdates.jsp">EditUpdates</a>
		</div>
		<h1 class="sub_head">Edit Notifications</h1>
			...
			<table border="1" class="table-fill">
				<thead>
					<tr>
						...
						<th class="text-left2" height="5" width="300">NOTIFICATION</th>
						<th class="text-left3" height="5" width="300">LINK</th>
				...
				List list=a.getnotificationList();
				Iterator<notification> itr=list.iterator();
				while(itr.hasNext())
					{
					notification t=itr.next();
					%>
						<tr style="width:100%;height: 10px;">
							<TD class="text-left1" ><%=i++%></TD>
							<TD class="text-left2" ><%=t.getMsg()%></TD>
							<TD class="text-left3"><%=t.getLink()%></TD>
							<TD id="cancel" class="text-left4">
								<form action="technicianremovenotification" method="post">
									<input type="hidden" name="id" value="<%=t.getId()%>"/>
									<input type="hidden" name="msg" value="<%=t.getMsg()%>"/>
									<input type="hidden" name="link" value="<%=t.getLink()%>"/>
