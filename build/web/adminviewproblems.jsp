...
.back_button
    ...
    <body>
		...
		<div class="topnav">
			...
			<a  style="background:#2196F3;"  href="adminviewproblems.jsp">ViewProblemsList</a>
		</div>
		<h1 class="sub_head">Problems List</h1>
			...
			<table border="1" class="table-fill">
				<thead>
					<tr>
						...
						<th class="text-left4" height="5" width="300">STATUS</th>
					</tr>
				</thead>
				<tbody class="table-hover">
				<%int i=1;
				adminmethods a=new adminmethods();
				List list=a.getproblems();
				Iterator<problemlist> itr=list.iterator();
				while(itr.hasNext())
					{
					problemlist u=itr.next();
					String color="blue";
					if(u.getPstatus().equals("pending"))
					{
						color="red";
					}
					else if(u.getPstatus().equals("success"))
					{
						color="green";
					}
					...
					%>
						<tr style="width:100%;height: 10px;">
							...
							<TD id="cancel"  style="color:<%=color%>"class="text-left4"><%=u.getPstatus() %></TD>
