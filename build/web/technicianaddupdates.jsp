	...
	*{
    ...
    <body>
		...
		<div class="topnav">
			...
			<a  class="active" href="technicianaddupdates.jsp">AddUpdates</a>
			<a href="technicianeditupdates.jsp">EditUpdates</a>
		</div>
		<h1 class="sub_head">Add New Updates</h1>
		<%
		...
		<div class="body_space">
			<form method="post" action="technicianaddupdates">
				
				<label for="user" style="margin-top:100px;" class="label">Update To Whom</label>
				<div class="textarea_class">
					<textarea maxlength="200" class="textarea" name="uabout" cols="39" rows="2" placeholder="Enter the datails about which branch you are giving update" required pattern=".{255}"></textarea>
				</div>
				<label for="user" style="margin-top:100px;" class="label">Problem Description</label>
				<div class="textarea_class">
					<textarea maxlength="200" class="textarea" name="udesc" cols="39" rows="2" placeholder="Enter the description of update with in 200 letters" required pattern=".{255}"></textarea>
				</div>
				<input style="font-size:20px;" class="post" type="submit" value="Post">
			</form>
			<%
				String updateerror,color="red";
				updateerror=(String)session.getAttribute("updateerror");
				if(updateerror==null || updateerror.isEmpty())
				{
					updateerror="Please Fill All Fileds....";
					color="green";
				}
				if(updateerror.equals("Update inserted successfully..."))
				{
					color="green";
				}
				session.setAttribute("updateerror",null);
			%>
			<p style="text-align:center;color:<%=color%>;text-size:26px;margin-top:375px;margin-right:110px;" text=" "> <%=updateerror %></p>
		</div>
