					...
					else if(pstatus.equals("inprogress"))
					{
					 ...
					 System.out.println(pdesc);
						...
						<div class="new_problem">
							...
							<form method="post" action="technicianaddslot">
								...
								<p class="para" style="margin-top:50px;">
									TIME SLOT &emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;:&emsp;
								</p>
								<div class="textarea_class">
									<textarea maxlength="200" class="textarea" name="time" cols="25" rows="2" placeholder="Enter tiem slot like :- Dec 16 10:30 AM" required pattern=".{255}"></textarea>
								</div>
								<input style="font-size:15px;" class="back_button1" type="submit" value="ADD SLOT">
							</form>
							<form action="techniciannewproblems.jsp" method="post">
