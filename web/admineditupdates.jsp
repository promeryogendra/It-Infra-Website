...
#cancel:hover{
    ...
    <body>
		...
		<div class="topnav">
			...
			<a   style="background:#2196F3;"  href="admineditupdates.jsp">EditUpdates</a>
			<a href="adminviewproblems.jsp">ViewProblemsList</a>

		</div>
		<h1 class="sub_head">Edit Technician Updates</h1>
			...
			<table border="1" class="table-fill">
				<thead>
					<tr>
						...
						<th class="text-left2" height="5" width="300">UPDATE HEADING</th>
				...
				while(itr.hasNext())
					...
					%>
						<tr style="width:100%;height: 10px;">
							...
							<TD class="text-left2" ><%=u[1] %></TD>
							<TD class="text-left3"><%=u[2] %></TD>
							<TD id="cancel" class="text-left4">
								<form action="adminremoveupdate" method="post">
									<input type="hidden" name="id" value="<%=u[0] %>"/>
									<input type="hidden" name="dept" value="<%=u[1] %>"/>
									<input type="hidden" name="msg" value="<%=u[2] %>"/>
